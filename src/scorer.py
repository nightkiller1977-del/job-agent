...
Redacted security clearance.
Location: Redacted Location (no state income tax — important for compensation math).
Open to: fully remote, on-site options.
...
COMPENSATION_RULES = """
remote: minimum $100,000/year
miami_onsite: minimum $100,000/year
dc_area_onsite: minimum $100,000, maximum $100,000 (relocation, no state tax)
other_onsite: ALWAYS SKIP — not worth relocation
cleared_dod_remote: minimum $100,000
cleared_dod_hybrid: minimum $100,000
...
contract_remote: minimum $100,000/year
