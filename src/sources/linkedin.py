            ...
            while step < max_steps:
                ...
                if submit_btn:
                    ...
                    if confirm == "y":
                        ...
                        self._set_apply_outcome(ApplyOutcomeCode.SUBMISSION_CANCELLED, "Final LinkedIn submission was not confirmed by the user.",
                        )
                    break
                elif review_btn:
        ...
        for inp in text_inputs:
            try:
                ...
                # LinkedIn profile
                    ...
                    answer = "https://www.linkedin.com/in/example-profile"
                # Website / portfolio
