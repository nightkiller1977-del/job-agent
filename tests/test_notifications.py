...
def test_notice_for_mapping():
    ...
    assert notice_for("reconciliation_required", "submit_unverified_unresolved") is NoticeClass.HUMAN_ACTION_REQUIRED
    assert notice_for("reconciliation_required", "duplicate_application_prevented") is NoticeClass.HUMAN_ACTION_REQUIRED
