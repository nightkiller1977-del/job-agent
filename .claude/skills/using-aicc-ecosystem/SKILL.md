...
4. Treat `aicc-secrets/render-sync-map.json` as a least-privilege Render distribution allowlist. A mapping may translate a service-scoped store key to a different runtime variable; update producer, consumer, mapping, and documentation together.
